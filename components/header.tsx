    ...
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#FE00C5] p-1.5 shadow-lg shadow-[#FE00C5]/20">
            <img src="/logo.png" alt="O2-5 Logo" className="h-full w-full object-contain" />
          </div>
          <span className="hidden text-xl font-black text-foreground tracking-tighter sm:inline uppercase">O2-5</span>
        </Link>
